...
class UntitledTestCase(unittest.TestCase):
    ...
    def Create_new_contact(self, wd, firstname, middlename, lastname, title, nickname, company, address, home, mobile,
                           work, fax, email2, email, email3, homepage, bday, bmonth, byear, aday, amonth, ayear):
        # Create new contact
